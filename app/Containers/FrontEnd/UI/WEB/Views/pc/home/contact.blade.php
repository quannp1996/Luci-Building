                        ...
                        <div class="row row1" id="row-1463025791">
                            <div class="col col1 medium-6 small-12 large-6">
                                <div class="col-inner">
                                    ...
                                    <div class="icon-box icon-box-awesome featured-box icon-box-left text-left align-top">
                                        ...
                                        <div class="icon-box-text last-reset">
                                            <p>
                                                <a href="mailto:{{ $settings['contact']['email'] }}">Email: <b>{{ $settings['contact']['email'] }}</b> </a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="icon-box icon-box-awesome featured-box icon-box-left text-left align-top">
                            ...
                            <div class="col medium-6 small-12 large-6">
                                <div class="col-inner">
                                    ...
                                    <div role="form" class="wpcf7" id="wpcf7-f606-p312-o1" lang="vi"
                                        dir="ltr">
                                        <form action="#" method="post" id="contact_form" class="wpcf7-form invalid" novalidate="novalidate">
                                            @csrf
                                                ...
                                                <div class="col pb-0 large-12">
                                                    <div class="col-inner"> 
                                                        <span class="wpcf7-form-control-wrap shop_name">
                                                            <input type="text"
                                                                name="shop_name" id="shop_name" value="" size="40"
            ...
            $('#submit_contact').click(function(){
                ...
                $.post('{{ route('api_contact_create_contact') }}', $('#contact_form').serialize()).then(function(json){
                    ...
                    Object.keys(errors).forEach(item => {
                        $('#contact_form .wpcf7-form-control-wrap input#' + item).addClass('wpcf7-not-valid');
                        $('#contact_form .wpcf7-form-control-wrap input#' + item).after('<span role="alert" class="wpcf7-not-valid-tip">'+ errors[item] +'</span>')
                    })
                }).always(function(){
