<div v-if="module.type == 'banner-top'">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <input v-bind:name="['module['+ module.key +'][mainImage]']"
                            @change="chageImage(module, 'mainImage' ,$event)" v-bind:id="[module.key + 'mainImage' ]"
                            type="file" class="form-control" style="display: none"
                            accept="image/png, image/jpeg, image/jpg" />
                        <img class="w-50 pointer" v-bind:src="module.mainImageLink"
                            @click="triggerFile(module, 'mainImage')" v-if="module.mainImageLink" />
